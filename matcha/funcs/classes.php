    ...
    class FUNCS {
        ...
        public function activate($token){
            ...
            if($found == 1)
            {
                ...
                echo "Account active, you can now Login ...<br><br>";
                ?>
                ...
                <div class="container-fluid">
                    <div class="nav navbar-toggler" id="navbarSupportedContent">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"><a href="user_profile.php"><span class="glyphicon glyphicon-user"></span> <?php print($this->get_column($_SESSION['id'],"username"));?></a></li>
                            <li class="nav-item"><a href="messages.php"><span class="glyphicon glyphicon-envelope"></span> Messages</a></li>
                            <li class="nav-item"><a href="index.php"><span class="glyphicon glyphicon-link"></span> Search</a></li>
                            <li class="nav-item dropdown">
                                <a class="dropdown01" href="funcs/notifications.php" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" onclick="reloader()">
                ...
                foreach($query as $i){
                    ...
                    ?>
                        ...
                        foreach ($sql as $user) {
                            ...
                            {
                                echo $user['username']." has un-liked you";
                            }
                            else if ($i['status'] == 'unread' && $i['thenotification'] == 'report')
                            {
                                echo "What the fuck did you do to ".$user['username']."!!!";
                            }
                        }
                        ?>
                    </a>
        ...
        public function dump_data($suggestedUsers, $user_id){
            ...
            ?>
                <button class="btn btn-secondary btn-danger" id="ageSort" value="ageSort">Sort by Age</button>
                <button class="btn btn-secondary btn-danger" id="locSort" value="locSort">Sort by Location</button>
                <button class="btn btn-secondary btn-danger" id="fameSort" value="fameSort">Sort by Fame-rating</button>
                <button class="btn btn-secondary btn-danger" id="tagSort" value="tagSort">Sort by Common Tags</button><br><br>
            <?php
